...
L["DATATEXT_DESC"] = "Setup the on-screen display of information texts."
...
The following search keywords can also be used:
    ...
    • power, powe, pow : Items granting Artifact Power.]=]L["SPELLBINDER_DESC"] = "Modify SpellBinder settings."
